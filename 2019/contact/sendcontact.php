...
define( "RECIPIENT_NAME", "samueltakuya" ); //UPDATE THIS TO YOUR NAME
define( "RECIPIENT_EMAIL", "sameltakuya@gmail.com" ); //UPDATE THIS TO YOUR EMAIL ID
define( "EMAIL_SUBJECT", "こころごすぺる｜お問い合わせフォームから" ); //UPDATE THIS TO YOUR SUBJECT

// Read the form values
$success = false;
$senderName = isset( $_POST['name'] ) ? preg_replace( "/^[ぁ-んァ-ヶーa-zA-Z0-9一-龠０-９、。\n\r]+$/u", "", $_POST['name'] ) : "";
...
{
	echo "<h1>メッセージの送信中に問題が発生しました。もう一度やり直してください。</h1>";
}
?>
